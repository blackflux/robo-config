- <a name="mock-plugin-task-idx-ref-nested-txt-overwritedefaultjson">:open_file_folder:</a> <a href="#mock-plugin-task-ref-nested-txt-overwritedefaultjson">`nested-txt-overwrite/@default.json`</a>
