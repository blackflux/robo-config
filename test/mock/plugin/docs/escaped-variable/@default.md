...
# :open_file_folder: <a name="mock-plugin-task-ref-escaped-variabledefaultjson">escaped-variable/@default.json</a> (<a href="#mock-plugin-task-idx-ref-escaped-variabledefaultjson">:link:`index`</a>)
