- <a name="mock-plugin-task-idx-ref-json-shallow-defaultdefaultjson">:open_file_folder:</a> <a href="#mock-plugin-task-ref-json-shallow-defaultdefaultjson">`json-shallow-default/@default.json`</a>
